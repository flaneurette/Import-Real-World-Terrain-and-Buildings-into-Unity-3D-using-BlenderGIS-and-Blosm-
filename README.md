...
Now, if you want to carve out waterways deeper and more realistic, you can do that with the other README. There is a seperate README and script, which you can also run if you want to carve deeper waterways than the SRTM provides (which is rather shallow as the SRTM lacks bathymetric information)
